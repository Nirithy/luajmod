...
final class Script.gotoPointer extends ApiFunction {
    ...
    public Varargs invoke2(Varargs varargs0) {
        long v = varargs0.checktable(1).rawget(varargs0.checkint(2)).rawget("value").tolong() + varargs0.checklong(3) & 0xFFFFFFFFL;
    ...
    @Override  // android.ext.Script$ApiFunction
    String usage() {
        return "gg.gotoPointer(table _address_table,int _index,long _offset,int _flags) -> table";
    }
}
